...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      ...
      >
        <aside className="p-4 hidden sm:block 2xl:w-64 bg-white flex-none border-r space-y-4 shadow-md">
          <div className="logo flex items-center border-b-2 pb-4 gap-2">
            ...
            <div className="txt hidden lg:block space-y-1">
        ...
        <main className="flex-grow flex flex-col overflow-auto bg-slate-100">
          <Header />
          <div className="sm:mx-6 sm:my-4 mx-2 my-4 flex-grow">{children}</div>
